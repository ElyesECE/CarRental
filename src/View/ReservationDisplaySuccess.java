 ...
 * @author pierr
 */
public class ReservationDisplaySuccess extends javax.swing.JFrame {
    ...
    public ReservationDisplaySuccess(Customer user) {
        initComponents();
        this.user = user;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Congratulations, your order has been placed !");

        jLabel2.setFont(new java.awt.Font("Lucida Sans Unicode", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("You will shortly receive an email regarding the details of your order");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservationDisplaySuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
